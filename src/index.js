// src/index.js — AriBot with BUTTON recruit + role-locked close/open
...
// ==== 모집 상태 저장: messageId -> { cap, hostId, members:Set, waitlist:Set, isClosed, title }
...
client.on(Events.InteractionCreate, async (i) => {
  try {
    if (i.isButton()) {
      ...
      // 상태 없으면 embed에서 Cap/Host 복구 시도(최소한으로)
